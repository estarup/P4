...
grid = new Grid(10, 10);CarSpawner spawnerSouth = new CarSpawner(2, 1, "South", 20, "southSpawner");grid.add(spawnerSouth);TrafficLight tf = new TrafficLight(2, 3, 10, "firstLight");grid.add(tf);
