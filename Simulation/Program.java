...
void Lights(){TrafficLight tf = new TrafficLight(2.0, 3.0, 10);trafficLights.add(tf);TrafficLight tf2 = new TrafficLight(2.0, 4.0, 10);trafficLights.add(tf2);}void Carspawner(int j){CarSpawner spawnerSouth = new CarSpawner(2.0, 2.0, "South", 10);carSpawners.add(spawnerSouth);}
    public void Run() {
int o;o = 2; Lights();Carspawner(p);
        while(true) {
